...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="filter">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                      ...
                      <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#add_operasidata"><i class="bi bi-file-earmark-plus mr-3"></i>Create</a></li>
                    </ul>
                </div>
                <div class="card-header">
                    <div class="row">
                        <div class="col">
                            <h5 class="card-title">S-Operasi</h5>
                        </div>
                        <div class="col button-container">
                            <h5 class="mt-0">
                                <div class="float-end">
                                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_operasidata">Create</a>
                                </div>
                            </h5>
                        </div>
                    </div>
                        ...
                        <table id="example1" class="display" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>0909-BBC/F022-K00/P9/0989</td>
            ...
            {{-- MODAL Tambah Data  --}}
            <div class="modal fade" id="add_operasidata" tabindex="-1" aria-labelledby="add_operasidata" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="add_operasidata">Create S.Operasi Data</h5>
