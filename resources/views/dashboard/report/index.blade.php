...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="filter">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                      ...
                      <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#addreportdata"><i class="bi bi-file-earmark-plus mr-3"></i>Create</a></li>
                    </ul>
                </div>
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col button-container">
                            <h5 class="mt-0">
                                <div class="float-end">
                                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addreportdata">Create</a>
                                </div>
                            </h5>
                        </div>
                    </div>
                        ...
                        <table id="example1" class="display" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="1" rowspan="2"scope="colgroup"class="text-center align-middle">No. Report</th>
                                    ...
                                    <th colspan="1" rowspan="2"scope="colgroup"class="text-center align-middle">Kecepatan Pembuatan Laporan <small>(Hari)</small></th>
                                ...
                                <tr>
                                    ...
                                    <th scope="colgroup">Tgl Penyerahan Laporan</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
            ...
            {{-- MODAL Tambah Data  --}}
            <div class="modal fade" id="addreportdata" tabindex="-1" aria-labelledby="addreportdata" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addreportdata">Create Report Data</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    {{-- No Report --}}
                                    <div class="col-12 col-md-6 mb-3">
                                        <label for="no-report" class="form-label">No Report</label>
                                        <input type="text" name="no-report" class="form-control" id="no-report" required>
                                        <div class="invalid-feedback">The field cannot be empty !</div>
                                    </div>
                                    ...
                                    {{-- Tanggal Penyerahan --}} 
                                    <div class="col-12 col-md-6 mb-3">
                                        <label for="tgl_penyerahan" class="form-label">Tgl Penyerahan</label>
                                        <input type="date" name="tgl_penyerahan" class="form-control" id="tgl_penyerahan" required>
                                        <div class="invalid-feedback">The field cannot be empty !</div>
                                    </div>

                                    {{-- Kecepatan Pembuatan --}} 
                                    <div class="col-12 col-md-6 mb-3">
                                        <label for="kec_pembuatanlaporan" class="form-label">Kcepatan Pembuatan Laporan <small>(hari)</small></label>
                                        <input type="text" name="kec_pembuatanlaporan" class="form-control" id="kec_pembuatanlaporan" required>
                                        <div class="invalid-feedback">The field cannot be empty !</div>
                                    </div>
