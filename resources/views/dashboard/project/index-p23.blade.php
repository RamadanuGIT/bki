                        ...
                        <table id="example1" class="display" style="width:100%">
                            <thead class="custom-th">
                                <tr>
                                    ...
                                    <th rowspan="3" scope="colgroup" class="text-center align-middle">SIKOM VS SAP</th>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            ...
                            {{--  --}} 
                            <div class="col-12 col-md-12 mb-3">
                                <label for="sikomvssap" class="form-label">SIKOM VS SAP</label>
                                <input type="number" name="sikomvssap" class="form-control" id="sikomvssap" required>
                                <div class="invalid-feedback">The field cannot be empty !</div>
                            </div>
