...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="filter">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                      ...
                      <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#addenergy-data"><i class="bi bi-file-earmark-plus mr-3"></i>Create</a></li>
                    </ul>
                </div>
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col button-container">
                            <h5 class="mt-0">
                                <div class="float-end">
                                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addenergy-data">Create</a>
                                </div>
                            </h5>
                        </div>
                    </div>
            ...
            {{-- MODAL Tambah Data  --}}
            <div class="modal fade" id="addenergy-data" tabindex="-1" aria-labelledby="addenergy-data" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addenergy-data">Create Energy Data</h5>
